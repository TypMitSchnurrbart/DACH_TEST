...
<html lang="de">
    <head>
        <title>DACH DHBW - Anmeldung</title>
        <meta charset="UTF-8">
    ...
    <body>
        <nav id="topNav" class="overlay-nav">
            <div class="overlay-nav-content">
                ...
                <a class="active" href="/index.html">Anmeldung</a>
        ...
        <div class="main-content">
            ...
            <main>
                <section class="main">
                    ...
                    <div>
                        <form class="form" id="loginForm" action="/scripts/main.py" target="_self" autocomplete="on" method="post" novalidate>
                            <div class="row">
                                <div class="col-25 test form-control">
                            ...
                            <div class="row">
                                <div class="col-25 test form-control" id="">
                            ...
                            <div class="row">
                                <input type="hidden" id="next_param" name="next_param" value="from_index_html">
                        ...
                        <p>Noch keinen Account? <a href="/HTML/register.html" >Hier registrieren!</a> </p>
                    </div>
                </section>
            </main>
            <footer>
